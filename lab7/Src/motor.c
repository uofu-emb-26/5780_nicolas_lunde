...
void encoder_init(void) {
    ...
    // 4 encoders per motor revolution (0.075s intervals)
    // 200 output RPM * 50:1 = 10000 motor RPM
    // 64 encoder counts per revolution * 10000 RPM = 640000 counts / min
...
void PI_update(void) {
     ...
     *       more resolution.
     */
    error = (4 * target_rpm) - motor_speed;
